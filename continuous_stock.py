...
def lookup_ticker(company):
  ticker_dictionary ={
     "Tesla Inc":{"tick":"TSLA"}, 
     "Honda Motor Co":{"tick":"HMC"}, 
     "Toyota Motor Corporation":{"tick":"TM"},
     "Volvo Group":{"tick":"VLVLY"},
...
async def update_csv_stock():
    ...
    try:
        companys = ["Tesla Inc", "General Motors Company", "Ford","Honda Motor Co","Toyota Motor Corporation","Hyundai Motor Company","Volvo Group","Mazda Motor Corp", "Nissan Motor Co Ltd", "Bayerische Motoren Wreke AG"]
